...
(0, _jquery2.default)(function () {
	(0, _jquery2.default)('#list>li:odd').css('backgroundColor', 'yellow');
	(0, _jquery2.default)('#list>li:even').css('backgroundColor', 'lightblue');
...
Student.info = { name: 'haozi', age: 20 };
...
module.exports = __webpack_require__.p + "images/img-319ea23.jpg";

/***/ }),
/* 12 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/img-f35e9ac.jpg";
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../_css-loader@0.28.4@css-loader/index.js!./bootstrap.min.css", function() {
			var newContent = require("!!../../../_css-loader@0.28.4@css-loader/index.js!./bootstrap.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
